function fullAvatarEditor() {
	...
	var file			= '/Public/statics/js/plugins/fullavatareditor/fullAvatarEditor.swf';		//flash文件的路径
	var	version			= "10.1.0";						//播放该flash所需的最低版本
	var	expressInstall	= '/Public/statics/js/plugins/fullavatareditor/expressInstall.swf';			//expressInstall.swf的路径
	var	width			= 900;							//flash文件的宽度
	var	height			= 500;							//flash文件的高度
