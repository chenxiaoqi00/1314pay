...
jQuery.fn.rater = function(options) {
    ...
    var settings = {
        ...
        title_format: null,
        info_format: null,
        image: '/Public/Center/images/comment/stars.jpg',
        imageAll: '/Public/Center/images/comment/stars-all.gif',
        defaultTips: true,
        clickTips: true,
        width: 24,
        height: 24
    ...
    content.find('.rater-star-item').mouseover(function() {
        ...
        jQuery(this).parents().nextAll('.rate-value').val(current_value);
