...
class Verify{
    ...
    public static function isUsername($str){
        ...
        return preg_match("/^[a-za-z]{1}([a-za-z0-9_]){5,15}$/",$str)? true : false;
    }
    ...
    public static function isMobile($str){
        $exp = "/^13[0-9]{1}[0-9]{8}$|15[012356789]{1}[0-9]{8}$|17[012356789]{1}[0-9]{8}$|18[012356789]{1}[0-9]{8}$|14[57]{1}[0-9]$/";
    ...
    */
    public static function length($str,$min=0,$max=0,$type=3,$charset = 'utf-8'){
        if(!self::isEmpty($str)) return false;
